...
export default function Generator() {
    ...
    return (
        <div className="bg-white dark:bg-zinc-900 shadow-xl rounded-2xl overflow-hidden border border-gray-200 dark:border-zinc-800 pb-20">
            ...
            <header className="bg-blue-600 dark:bg-blue-700 p-8 text-white flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Packing Slip Generator</h2>
                ...
                <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <section className="space-y-4">
                            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 border-b border-gray-200 dark:border-zinc-700 pb-2">
                                Sender (From)
                            </h3>
                    ...
                    <section className="space-y-4 pt-4 border-t border-gray-100 dark:border-zinc-800">
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Shipment Details</h3>
                    ...
                    <section className="pt-6">
                        <div className="flex justify-between items-end mb-4">
                            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Packing List</h3>
                    ...
                    <section className="pt-6 border-t border-gray-100 dark:border-zinc-800">
                        <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3">Notes & Instructions (Optional)</h3>
                        <textarea
                            rows={4}
